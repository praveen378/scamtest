...
import { login as authLogin } from "../../store/authSlice.js"; // Redux action for login
import authService from "../../auth/auth.js"; // Assume authService is defined for login functionality
